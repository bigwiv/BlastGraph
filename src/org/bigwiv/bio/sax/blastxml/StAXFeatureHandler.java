...
//    static final String biojavaUri = "biojava";
 ...
 // class variables
    static AttributesImpl bldsAttrs = null;
	static AttributesImpl dbAttrs = null;
...
//        System.out.println("in StAXFeatureHandler. staxenv is " + staxenv);
	...
	public void endElement(
            ...
            StAXContentHandler handler)
             throws SAXException {
      //System.out.println("StAXFeatureHandler endElement called, localName, level: " + localName + " " + level);
        if ((--level) == 0) {
